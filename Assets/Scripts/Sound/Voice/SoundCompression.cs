...
public class SoundCompression : MonoBehaviour
{
    public static SpeexEncoder encoder = new SpeexEncoder(BandMode.Wide);
    public static SpeexDecoder decoder = new SpeexDecoder(BandMode.Wide);
